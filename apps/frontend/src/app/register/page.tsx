...
import { canRegisterUser, isValidNationalId } from '../../lib/marketplace';
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-6">
      ...
      >
        ...
        <input name="nationalId" required placeholder="National ID (AR-12345678)" className="rounded border p-2" />
