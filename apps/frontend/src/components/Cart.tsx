...
export function CartSummary() {
  ...
  const shippingEstimate = total > 100 ? 0 : 12.99;
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <p className="text-sm text-slate-600">Shipping estimate: ${shippingEstimate.toFixed(2)}</p>
      <p className="text-xl font-bold text-blue-600">Total: ${grandTotal.toFixed(2)}</p>
